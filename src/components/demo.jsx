...
import { Sun, Moon, Menu, X, ChevronDown, Wifi, Camera, MapPin, Zap, Shield, Volume2, BarChart3, Users, Award, Leaf, Star } from 'lucide-react';
...
function Smartbus() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['home', 'overview', 'solutions', 'features', 'analytics', 'future', 'why-choose'];
  ...
  const features = [
    {
      ...
      description: "Advanced surveillance with facial recognition and threat detection for enhanced passenger safety."
    },
    {
      icon: <MapPin className="w-8 h-8" />,
      title: "GPS Tracking",
      description: "Real-time location monitoring and route optimization for efficient fleet management."
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "LED Info Systems",
      description: "Dynamic digital displays providing real-time updates on routes, schedules, and announcements."
    },
    {
      icon: <Wifi className="w-8 h-8" />,
      title: "Wi-Fi Connectivity",
      description: "High-speed internet access for passengers and IoT device connectivity."
    },
    {
      icon: <Volume2 className="w-8 h-8" />,
      title: "Smart PA System",
      description: "Automated announcements with multi-language support and emergency alerts."
    },
    {
  ...
  const innovations = [
    {
      ...
      description: "Intelligent driving support with predictive analytics and autonomous capabilities."
    },
    {
      title: "Facial Recognition Boarding",
      description: "Contactless boarding system using biometric authentication for seamless passenger experience."
    },
    {
      title: "Smart City Integration",
      description: "Seamless connectivity with urban infrastructure for optimized traffic flow and energy management."
    }
  ];

  const benefits = [
    { icon: <Users className="w-6 h-6" />, title: "Happy Passengers", description: "Enhanced comfort and convenience" },
    { icon: <Shield className="w-6 h-6" />, title: "Safe Travel", description: "Advanced security and monitoring" },
    { icon: <Leaf className="w-6 h-6" />, title: "Eco-Friendly", description: "Reduced carbon footprint" },
    { icon: <Award className="w-6 h-6" />, title: "Award-Winning", description: "Industry recognition and excellence" }
  ];
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white transition-colors duration-300">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-fade-in-up">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto">
              Transforming urban mobility with cutting-edge technology, AI-powered systems, and sustainable solutions for the future of public transportation.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">
                ...
                <span className="text-blue-600 dark:text-blue-400"> Ecosystem</span>
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-300">
                Our Smart Bus Solution integrates advanced AI technology, IoT sensors, and real-time data analytics to create a seamless, efficient, and sustainable public transportation network.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Experience the future of public transportation with our comprehensive smart bus interior featuring GPS navigation, advanced CCTV systems, and seamless Wi-Fi connectivity.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl">
                ...
                <p className="text-gray-600 dark:text-gray-300">Real-time route optimization and passenger information displays.</p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl">
                <Camera className="w-8 h-8 text-teal-600 dark:text-teal-400 mb-3" />
                <h3 className="text-xl font-semibold mb-2">CCTV Security</h3>
                <p className="text-gray-600 dark:text-gray-300">Advanced surveillance with AI-powered monitoring and alerts.</p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl">
                <Wifi className="w-8 h-8 text-orange-600 dark:text-orange-400 mb-3" />
                <h3 className="text-xl font-semibold mb-2">Wi-Fi Hotspot</h3>
                <p className="text-gray-600 dark:text-gray-300">High-speed internet connectivity for all passengers onboard.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="features" className="py-20 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Discover the advanced technologies that power our smart bus solution, from AI-driven systems to cutting-edge safety protocols.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="group bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300">
                Harness the power of real-time data analytics to optimize routes, predict passenger flow, and enhance operational efficiency with our comprehensive dashboard.
              </p>
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center space-x-3">
                  <BarChart3 className="w-6 h-6 text-blue-600 dark:text-blue-400" />
                  <span className="text-gray-700 dark:text-gray-300">Route Analytics</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Users className="w-6 h-6 text-teal-600 dark:text-teal-400" />
                  <span className="text-gray-700 dark:text-gray-300">Passenger Flow</span>
                </div>
                <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">Energy Usage</span>
                </div>
              </div>
            </div>
            <div className="relative">
      ...
      <section id="future" className="py-20 bg-gradient-to-br from-blue-50 to-teal-50 dark:from-gray-800 dark:to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
              Future-Ready Innovations
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Pioneering the next generation of public transportation with AI driver assistance, biometric boarding, and seamless smart city integration.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {innovations.map((innovation, index) => (
              <div key={index} className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm p-8 rounded-2xl border border-white/20 dark:border-gray-700/20">
      ...
      <section id="why-choose" className="py-20 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Experience the perfect blend of comfort, safety, and sustainability with our award-winning public transportation system.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                "The smart bus system has completely transformed my daily commute. It's reliable, comfortable, and eco-friendly."
              </p>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                "Outstanding technology integration. The Wi-Fi and real-time updates make travel so much more convenient."
              </p>
              <div className="text-sm text-gray-500 dark:text-gray-400">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                "Safety and security features give me peace of mind. This is the future of public transportation."
              </p>
              <div className="text-sm text-gray-500 dark:text-gray-400">
                - Maria L., Student
              </div>
